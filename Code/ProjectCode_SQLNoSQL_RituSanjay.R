...
library("stats4", lib.loc="C:/Program Files/R/R-3.5.1/library")
...
dbGetQuery(connect,"SELECT countrycode,seriesname FROM CPI ")
...
chn_inflation <- Inflation[2,5:54]
ind_inflation <- Inflation[3,5:54]
rus_inflation <- Inflation[4,5:54]
zaf_inflation <- Inflation[5,5:54]
...
chn_ppp_gni_ts<-ts(as.double(chn_ppp_gni[,22:49]),start=1990,end=2017)
...
bra_exports_manufacturing_ts<-ts(as.double(bra_exports_manufacturing[,28:49]),start=1996,end=2017)
...
chn_exports_manufacturing_ts<-ts(as.double(chn_exports_manufacturing[,28:49]),start=1996,end=2017)
...
ind_exports_manufacturing_ts<-ts(as.double(ind_exports_manufacturing[,28:49]),start=1996,end=2017)
...
rus_exports_manufacturing_ts<-ts(as.double(rus_exports_manufacturing[,28:49]),start=1996,end=2017)
...
zaf_exports_manufacturing_ts<-ts(as.double(zaf_exports_manufacturing[,28:49]),start=1996,end=2017)
...
#CPI
bra_cpi_ts <- ts(as.double(bra_cpi[,22:49]),start=1990,end=2017)
chn_cpi_ts <- ts(as.double(chn_cpi[,22:49]),start=1990,end=2017)
ind_cpi_ts <- ts(as.double(ind_cpi[,22:49]),start=1990,end=2017)
rus_cpi_ts <- ts(as.double(rus_cpi[,22:49]),start=1990,end=2017)
zaf_cpi_ts <- ts(as.double(zaf_cpi[,22:49]),start=1990,end=2017)
